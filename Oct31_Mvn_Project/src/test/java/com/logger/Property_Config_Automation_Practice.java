...
public class Property_Config_Automation_Practice extends Utility_Files {

	public static Logger log = Logger.getLogger(Property_Config_Automation_Practice.class);
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		log.info("HomePage Session created.");
		...
		log.info("Successfully logged into the account.");
		...
		log.info("Dresses -> Casual Dresses selected.");
		...
		log.info("Purchased Casual Dress Successfuly.");

		//Dresses -> Evening Dresses
		
		log.info("Dresses -> Evening Dresses selected.");
		...
		log.info("Purchased Evening Dress Successfuly.");
		
		// Dresses -> Summer Dress
		
		log.info("Dresses -> Summer Dresses selected.");
		...
		log.info("Purchased Summer Dress Successfuly.");
